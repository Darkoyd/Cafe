...
/**
 * Clase que permite administrar la conexi�n con la base de datos de juveniles
 *
 */
public class AdministradorBaseDeDatos 
{
	...
	{
		//Define el driver (programa) que se encarga de hacer la conexi�n entre java y la base de datos
		Locale.setDefault(new Locale("ln", "CO"));
		String driver = config.getProperty( "admin.db.driver" );
		Class.forName( driver ).newInstance( );

		//Define el nombre que tendr� la base de datos
